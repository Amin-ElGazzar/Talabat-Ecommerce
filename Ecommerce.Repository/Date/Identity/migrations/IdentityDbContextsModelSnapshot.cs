...
{
    [DbContext(typeof(IdentityDbContexts))]
    partial class IdentityDbContextsModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Identity.Address", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entities.Identity.ApplicationUser", "User")
                        .WithOne("Address")
                        .HasForeignKey("Ecommerce.Domain.Entities.Identity.Address", "ApplicationUserId")
